...
print(
    f"Start weight date:   {start_weight_date} ({start_weight_lbs} lbs, {start_bmi} bmi, {start_current_weight_lbs_diff} of {start_target_weight_lbs_diff} lbs lost)")
print(
    f"Current weight date: {current_weight_date} ({current_weight_lbs} lbs, {current_bmi} bmi, {current_percent_lost_lbs}% of target weight lost)")
print(
